...
const docTemplatetimescalewrapper = `{
...
// SwaggerInfotimescalewrapper holds exported Swagger Info so clients can modify it
var SwaggerInfotimescalewrapper = &swag.Spec{
	Version:          "0.1",
	Host:             "",
	BasePath:         "/",
	Schemes:          []string{},
	...
	Description:      "",
	InfoInstanceName: "timescalewrapper",
	SwaggerTemplate:  docTemplatetimescalewrapper,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfotimescalewrapper.InstanceName(), SwaggerInfotimescalewrapper)
}
